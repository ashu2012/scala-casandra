...
object Connector {
  ...
  /**
    ...
    *
    */
  lazy val connector: CassandraConnection = ContactPoints(hosts).withClusterBuilder(_.withCredentials("iccassandra", "0H8xUgtvOQI8uqC8")).keySpace("DESCRIBE keyspaces;")
